...
Use Fable for planning, coordination, deep analysis, and insight generation. Delegate lightweight research and cleanly scoped lightweight subtasks to Sonnet. Delegate intermediate or nuanced research, synthesis, critique, and review tasks to Opus. Delegate heavy research, cleanly scoped heavy subtasks, and all implementation tasks—regardless of size or complexity—to Codex configured with GPT-5.5.
